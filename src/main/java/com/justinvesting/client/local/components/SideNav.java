...
import com.justinvesting.client.local.pages.Home;
import com.justinvesting.client.local.pages.NamePage;
import com.justinvesting.client.local.pages.PeoplePage;

@Templated("/com/justinvesting/client/templates/components/SideNav.html")
